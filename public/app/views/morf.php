...
<head>
  ...
  <link rel="stylesheet" href="<?= $basePath ?>assets/narciso.css">
</head>
...
<body>
  ...
  <header class="topo">
    ...
    <img src="<?= $basePath ?>assets/images/vr_logo_2026.png" alt="Logótipo Val do Rio">
  </header>
  ...
  <form id="formulario" action="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>" method="POST" accept-charset="UTF-8">
  ...
  <?php if ($flash): ?>
    <div
      id="flash-feedback"
      class="hidden"
      data-type="<?= htmlspecialchars((string)($flash['type'] ?? ''), ENT_QUOTES, 'UTF-8') ?>"
      data-title="<?= htmlspecialchars((string)($flash['title'] ?? ''), ENT_QUOTES, 'UTF-8') ?>"
      data-message="<?= htmlspecialchars((string)($flash['message'] ?? ''), ENT_QUOTES, 'UTF-8') ?>"
    ></div>
  <?php endif; ?>

  <script src="<?= $basePath ?>assets/heavywork.js" defer></script><script src="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>assets/js/heavywork.js" defer></script>
